...
public final class WeatherUtils {
    ...
    public static String formatTemperatureNoUnit(Context context,double temp){
    ...
    public static int getLargeArtResourceForWeatherCondition(int weatherId) {
        ...
        } else if (weatherId == 762 || weatherId == 771 || weatherId == 781) {
            return R.drawable.ic_storm;
     ...
     * @return resource id for the corresponding icon. -1 if no relation is found.
     */
    public static int getSmallArtResourceForWeatherCondition(int weatherId) {
        /*
         * Based on weather code data found at:
         * See http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
         */
